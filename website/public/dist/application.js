...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleVendorDependencies = ['ngResource', 'ngCookies',  'ngAnimate',  'ngTouch',  'ngSanitize',  
		'ui.router', 'ui.bootstrap', 'ui.utils', 'vk', 'gridster', 'nvd3', 'ui.bootstrap.datetimepicker', 'ngFileUpload', 'ui.grid', 
...
ApplicationConfiguration.registerModule('abcd');
...
angular.module('core').service('Menus', [
	...
	function() {
		...
		// Set a items top bar menu item
		this.addMenuItem('topbar', 'Web Application', 'item', 'dropdown', '/');
	}
]);
'use strict';
