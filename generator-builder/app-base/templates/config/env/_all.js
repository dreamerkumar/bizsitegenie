	...
	assets: {
		lib: {
			css: [
				...
				<%if(bootstrapTheme && bootstrapTheme !== 'default'){%>'https://maxcdn.bootstrapcdn.com/bootswatch/3.3.4/<%=bootstrapTheme%>/bootstrap.min.css',<%} else {%>'public/lib/bootstrap/dist/css/bootstrap-theme.css',<%}%>
			],
			js: [
