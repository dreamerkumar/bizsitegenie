...
var ModuleGenerator = yeoman.generators.NamedBase.extend({
	init: function() {
		...
		this.camelizedPluralName = _str.camelize(this.slugifiedPluralName);
		this.camelizedSingularName = _str.camelize(this.slugifiedSingularName);

		this.classifiedPluralName = _str.classify(this.slugifiedPluralName);
		this.classifiedSingularName = _str.classify(this.slugifiedSingularName);

		this.humanizedPluralName = _str.humanize(this.slugifiedPluralName);
		this.humanizedSingularName = _str.humanize(this.slugifiedSingularName);
	},
	...
	askForModuleFolders: function() {
		...
		this.prompt(prompts, function(props) {
			this.addCSSFolder = _str.contains(props.folders, 'addCSSFolder');
			this.addImagesFolder = _str.contains(props.folders, 'addImagesFolder');
			this.addDirectivesFolder = _str.contains(props.folders, 'addDirectivesFolder');
			this.addFiltersFolder = _str.contains(props.folders, 'addFiltersFolder');
