...
var ModuleGenerator = yeoman.generators.NamedBase.extend({
	...
	askForModuleFolders: function() {
		...
		this.prompt(prompts, function(props) {
			this.addConfigFolder = _str.contains(props.folders, 'addConfigFolder');
			this.addControllersFolder = _str.contains(props.folders, 'addControllersFolder');
			...
			this.addServicesFolder = _str.contains(props.folders, 'addServicesFolder');
			this.addTestsFolder = _str.contains(props.folders, 'addTestsFolder');
			this.addViewsFolder = _str.contains(props.folders, 'addViewsFolder');
